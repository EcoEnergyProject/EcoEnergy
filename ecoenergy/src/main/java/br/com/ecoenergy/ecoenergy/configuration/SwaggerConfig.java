package br.com.ecoenergy.ecoenergy.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		...
		.basePackage("br.com.ecoenergy.ecoenergy.controller"))
	...
	public static ApiInfo metadata() {
		...
		return new ApiInfoBuilder()
			.title("API - EcoEnergy")
			.description("Projeto API Spring - EcoEnergy")
			.version("1.0.0")
			.license("Apache License Version 2.0")
			.licenseUrl("https://github.com/EcoEnergyProject")
			.contact(contact())
			.build();
	}
	...
	private static Contact contact() {
		...
		return new Contact("EcoEnergy", 
			"https://github.com/EcoEnergyProject", 
			"ecoenergy.generation@gmail.com");
